...
const services = [
	...
	{
		src: require('../../images/service/dry-cleaning.jpg'),
		name: 'Dry Cleaning',
		...
		<section className="mb-3" id="services">
			<Container>
				<div className="d-flex justify-content-center mt-5">
					<h2 className="color-reuse head-title">Our Services</h2>
				</div>
				<Row>
					{services.map(service => (
						<Col md={4} className="d-flex justify-content-center mt-4" key={service.src}>
							<Card style={{ width: '20rem' }}>
								...
								<CardBody>
									<CardTitle tag="h3" className="color-reuse">
										{service.name}
									</CardTitle>
									<CardText>{service.title}</CardText>

									<Link to={service.link}>
										<Button style={{backgroundColor:'#1D1E4D'}} className="service-button">
